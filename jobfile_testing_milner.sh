...
aprun -n 40 python /cfs/milner/scratch/b/bkaplan/OculomotorControl/main_testing.py Training_OpenLoop_titer25_nRF50_nV50_vmin0.10_vmax12.00_nStim4x900_nactions17_blurX0.05_V0.05_taup360000  > delme_testing 2>&1
