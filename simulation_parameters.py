...
class global_parameters(ParameterContainer.ParameterContainer):
    ...
    def set_default_params(self):
        ...
        self.params['n_rf'] = 50
        self.params['n_v'] = 50
        self.params['softmax_action_selection_temperature'] = 1.5
...
#        else:
        ...
        #self.params['test_stim_range'] = [300 + i * 3 for i in xrange(15)] #range(0, 10)
...
#        self.params['load_mpn_d2_weights'] = False
        ...
        if self.params['training']:
            if self.params['reward_based_learning']:
                self.params['sim_id'] = '_noOverlapShuffled_nIt%d_temp%.1f_nC%d_' % (self.params['n_max_trials_same_stim'], self.params['softmax_action_selection_temperature'], self.params['n_training_cycles'])
...
#            self.params['sim_id'] = '%d_K10g0.2_' % (self.params['t_iteration'])
            self.params['sim_id'] = '%d_315tr_' % (self.params['t_iteration'])
