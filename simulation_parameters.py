...
#        self.params['initial_state'] = (.631059, .5, 0.1996527, .0)
        ...
        self.params['suboptimal_training'] = 3 # if non-zero, then main_training_iteratively_suboptimally_supevised will randomize the supervisor-action by this integer number
        if self.params['training']:
...
#            self.tau_p = 1. * self.params['t_sim']
        ...
        self.params['mpn_d1_weight_amplification'] = 0.6
        self.params['mpn_d2_weight_amplification'] = 0.6
#        if self.params['reward_based_learning']:
            ...
            if self.params['training']:
                ...
                folder_name += '_it%d_d1pos%.2e_d1neg%.2e_mpn-d1-%.2e_mpn-d2-%.2e_bias%.2e/' % \
                        (self.params['t_iteration'], \
                                ...
                                self.params['mpn_d1_weight_amplification'], self.params['mpn_d2_weight_amplification'], self.params['mpn_bg_bias_amplification'])
