...
aprun -n 120 -N 40 python /cfs/milner/scratch/b/bkaplan/OculomotorControl/main_training_reward_based_new.py Training_RBL_withMpnNoise_titer25_nStim2_2-4_gain1.00_seeds_111_1/ Training_RBL_withMpnNoise_titer25_nStim2_4-6_gain1.00_seeds_111_1/ training_stimuli_nV11_nX7.dat 4 > delme_rbl_4 2>&1

#aprun -n 120 -N 40 python /cfs/milner/scratch/b/bkaplan/OculomotorControl/main_training_reward_based_new.py Training_RBL_titer25_nStim4_4-8_gain2.00_seeds_111_1  Training_RBL_titer25_nStim10_8-18_gain2.00_seeds_111_1/ training_stimuli_nV11_nX7.dat 8 > delme_rbl_8 2>&1
#aprun -n 120 -N 40 python /cfs/milner/scratch/b/bkaplan/OculomotorControl/main_training_reward_based_new.py Training_RBL_titer25_nStim10_8-18_gain2.00_seeds_111_1/ Training_RBL_titer25_nStim10_18-28_gain2.00_seeds_111_1/ training_stimuli_nV11_nX7.dat 18 > delme_rbl_18 2>&1
#aprun -n 120 -N 40 python /cfs/milner/scratch/b/bkaplan/OculomotorControl/main_training_reward_based_new.py Training_RBL_titer25_nStim10_18-28_gain2.00_seeds_111_1/ Training_RBL_titer25_nStim10_28-38_gain2.00_seeds_111_1/ training_stimuli_nV11_nX7.dat 28 > delme_rbl_28 2>&1
