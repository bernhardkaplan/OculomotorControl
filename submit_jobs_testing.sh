...
#do
    ...
    #do
        ...
        for wa_d1_d1_neg in 10.  # weight amplification d1 -> d1 negative weights
        do
            for wa_d1 in 0.1 0.2 0.3  #weight amplification for BCPNN MPN -> D1 weights
            do
                for wa_d2 in 0.1 0.3 0.5 
                do
