...
aprun -n 160 -N 40 python /cfs/milner/scratch/b/bkaplan/OculomotorControl/main_training_reward_based_new.py training_stimuli_nV16_nX20_seed2_centered_first.dat  0 > delme_rbl_K20_-20 2>&1
