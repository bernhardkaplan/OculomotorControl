...
aprun -n 40 python /cfs/milner/scratch/b/bkaplan/OculomotorControl/main_testing_param_sweep.py Training_RBL_3_titer25__3_nStim50x7_taup50000_gain1.00  $1 $2 $3 $4 $5 $6 > delme_testing_$3.txt 2>&1
